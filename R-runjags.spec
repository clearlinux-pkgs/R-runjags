...
popd
pushd ..
cp -a runjags buildavx512
popd
pushd ..
cp -a runjags buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740099477
...
/V4/usr/lib64/R/library/runjags/libs/runjags.so
/VA/usr/lib64/R/library/runjags/libs/runjags.so
