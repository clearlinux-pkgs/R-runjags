...
Version  : 2.2.1.5
Release  : 32
URL      : https://cran.r-project.org/src/contrib/runjags_2.2.1-5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/runjags_2.2.1-5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646878979
